...
exports.GLM.thinsvd = function (A) {
    ...
    while (p > 0) {
		...
		if(totiter>1000 || iter>1000) {
			//console.log("SVD Did not converge")
			return false;
...
exports.GLM.optimization.IRLS = function (endogenous,
  ...
  while (!converged) {
    ...
    //console.log("step 5")
	if(!wlsResults) return false//error on SVD
	...
	if(iterations>100 && converged==false){
		alert("did not converge")
		return false;
	}
  }
  //console.log(iterations + " iterations and converged")
  return wlsResults;
};
...
exports.GLM.optimization.linearSolve = function (A, b, weights) {
  ...
  //console.log("linearSolve step1")
  A = whiten(A, weights);
  //console.log("linearSolve step2")
  b = whiten(b, weights);
  ...
  //console.log("linearSolve step3")
  var decomposition = exports.GLM.thinsvd(exports.GLM.utils.dot(exports.GLM.utils.transpose(b), b))
  //console.log("linearSolve step4")
  if(!decomposition) return false;
  var U = decomposition[0]
  //console.log("linearSolve step5")
  var S_inverse = project_and_invert(decomposition[1])
  //console.log("linearSolve step6")
  var V = decomposition[2]
  //console.log("linearSolve step7")
  var psuedoinv = exports.GLM.utils.dot(U, exports.GLM.utils.dot(S_inverse, exports.GLM.utils.inverse(V)))
  //console.log("linearSolve step8")
  var solution = exports.GLM.utils.dot(exports.GLM.utils.dot(psuedoinv, exports.GLM.utils.transpose(b)), A);
  //console.log("linearSolve step9")
  return solution;
}
})(this);
